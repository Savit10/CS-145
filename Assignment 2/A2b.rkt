...
(define (steps-fib n) (if (or (equal? n 1) (equal? n 0)) 3 (+ 6 (steps-fib(- n 1)) (steps-fib(- n 2)))))
...
(define (compare-steps-m n) (if (< (steps-fib n) (step-count-m n)) 'fewer (if (equal? (steps-fib n) (step-count-m n)) 'same 'more)))
